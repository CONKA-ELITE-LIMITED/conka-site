...
import IngredientsPanel from "../landing/IngredientsPanel";
...
export default function CROFormulaSplit() {
  ...
  return (
    <div>
      ...
      <p className="brand-mono-sub mb-10">
        16 active ingredients · 2 daily shots · clinically dosed
      </p>
