...
export default function AppInsightsCallout() {
  return (
    <a
      href="/app-insights"
      className="group block border border-white/20 bg-white/[0.10] p-6 lg:p-10 transition-colors hover:bg-white/[0.15] focus:outline-none focus-visible:bg-white/[0.15] focus-visible:border-white/40"
    >
      ...
      <p className="text-base lg:text-lg text-white/90 leading-relaxed max-w-[58ch] mb-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-white/75 tabular-nums">
