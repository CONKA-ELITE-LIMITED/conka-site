...
export default function AthleteReviewFeature({
  ...
  return (
    <div className="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
      {/* Cutout portrait in the App USP soft panel: #eef1f8 tint, rounded-md,
      ...
      <div className="relative mx-auto w-full max-w-[420px] aspect-square overflow-hidden rounded-md bg-[#eef1f8] ring-1 ring-black/8 lg:mx-0 lg:max-w-none">
        <Image
          src={athlete.image}
