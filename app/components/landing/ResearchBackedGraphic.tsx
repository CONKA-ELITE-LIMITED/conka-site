...
function BadgeChip({ src, alt }: { src: string; alt: string }) {
  return (
    <div className="flex h-[68px] items-center justify-center rounded-lg bg-white px-3 py-2.5 shadow-[0_8px_24px_rgba(10,15,30,0.22)]">
  ...
  return (
    <div className="relative overflow-hidden rounded-lg p-6 md:p-8">
      ...
      <div className="relative z-10">
        <p className="mb-5 text-center text-[12px] font-semibold text-white/80">
        ...
        <div className="mb-4 grid grid-cols-3 gap-2.5">
          {UNIVERSITIES.map((u) => (
            <div
              key={u.alt}
              className="flex h-[88px] items-center justify-center rounded-lg bg-white px-3 py-4 shadow-[0_10px_28px_rgba(10,15,30,0.24)]"
            >
              <div className="relative h-full w-full">
                <Image
                  src={u.src}
        ...
        <div className="grid grid-cols-3 gap-2.5">
          ...
          <div className="flex h-[68px] flex-col items-center justify-center gap-1.5 rounded-lg bg-white px-2 py-2.5 shadow-[0_8px_24px_rgba(10,15,30,0.22)]">
            <TrustIconGuarantee className="h-6 w-6 text-[var(--brand-navy)]" />
