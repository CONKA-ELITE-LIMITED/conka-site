          ...
          <div className="grid grid-cols-3 gap-6">
            {NAV_PRODUCTS.map((product) => (
              <Link
                ...
                className="group relative flex flex-col overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-transparent transition-[transform,box-shadow] duration-200 hover:-translate-y-1 hover:ring-2 hover:ring-white"
              >
