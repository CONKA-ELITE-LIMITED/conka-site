...
/**
 * /appv2 — interactive, GSAP-driven take on the app page. Same copy and
 * assets as /app, tighter spine: the sticky-phone and feature-panel beats are
 * merged into one pinned journey so proof lands sooner, and the proof section
 * closes the loop back to the product. Noindexed + canonicalised to /app
 * while it is an experiment.
 */
