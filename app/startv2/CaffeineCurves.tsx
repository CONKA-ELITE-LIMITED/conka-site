  ...
  return (
    <div ref={ref} className="bg-white rounded-[12px] p-5 md:p-6">
      ...
      >
        ...
        {/* Coffee curve — halo + stroke. First peak high, mild dip,
            second peak slightly lower, then a deep crash below baseline,
            recovery into a still-elevated evening tail. */}
        <path
          d="M 30 115 C 60 110, 85 65, 110 50 C 145 45, 175 120, 200 125 C 225 130, 245 132, 260 128 C 285 115, 295 70, 320 65 C 350 65, 380 150, 400 160 C 430 155, 445 140, 460 125 C 490 105, 540 90, 610 80"
          fill="none"
          stroke="#F59E0B"
          strokeWidth="10"
          strokeOpacity="0.2"
        ...
        {/* drink markers — first cup at 8AM, second cup at the noon trough */}
        <circle
          cx="30"
          cy="115"
          r="7"
