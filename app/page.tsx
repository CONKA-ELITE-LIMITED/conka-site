...
export const metadata: Metadata = {
  ...
  description: `CONKA is the UK's leading daily brain shot, Informed Sport certified, backed by Cambridge, Durham and Exeter. 100-day guarantee. From £${getFunnelMinPerShot(
    "both",
  ).toFixed(2)}/shot.`,
  openGraph: {
    title: "Best Brain Supplement UK | CONKA Daily Brain Shot",
