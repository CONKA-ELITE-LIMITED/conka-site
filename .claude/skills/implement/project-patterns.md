...
- **Offer catalogue:** `app/lib/offerData.ts` (prices, variants and selling plans for every selling surface, not just `/build-your-order`; PDPs reach it via the `cadenceData.ts` adapter)
