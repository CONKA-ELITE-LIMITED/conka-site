...
| `docs/product/SKU_AND_SHOT_REFERENCE.md` | **Canonical SKU + shot-count map** — funnel / main-site / legacy protocol variant GIDs, selling plans, shot counts, prices, and the account per-shot display logic + its known bug |
