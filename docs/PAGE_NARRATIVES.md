...
| 6 | The Scientists (`SciencePeople`) | Eight named scientists with black-and-white photos, their role and a university logo (or organisation); a swipe carousel on mobile, a four-column grid on desktop | OK | Scientists only, founders stay on /our-story. Katekhaye has no institution on record |
