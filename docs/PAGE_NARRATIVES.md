...
| 6 | The Scientists (`SciencePeople`) | Seven named scientists with black-and-white photos, their role in our research and institution; a swipe carousel on mobile, one row on desktop | OK | Scientists only, founders stay on /our-story. Katekhaye has no institution on record |
