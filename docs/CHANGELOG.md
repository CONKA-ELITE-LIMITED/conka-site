...
- **2026-07-10** | SEO: unique title tags, meta descriptions and OpenGraph on the 5 core pages (home, Flow, Clear, Both, Ingredients); Flow PDP H1 now reads CONKA Flow not FL0W (SCRUM-1132)
