...
- **2026-09-25** | Native web cognition test engine (React port of the app's test, scored by our own server) with an internal demo at /cognitive-test-demo; not yet swapped into the live site test (SCRUM-1456)
